...
private:
    ...
    // for Physio16
    bool is_connected_physio_1_ = false;
    bool is_connected_physio_2_ = false;
    float scalingFactor_physio_07 = -0.00111758708;
    float scalingFactor_physio_815 = 0.00111758708;
