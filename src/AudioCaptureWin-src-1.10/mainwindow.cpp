...
//                    boost::this_thread::sleep(boost::posix_time::milliseconds(1000.0 * update_interval));
                    boost::this_thread::sleep(boost::posix_time::milliseconds(lround(1000.0 * update_interval)));
...
//                    boost::this_thread::sleep(boost::posix_time::milliseconds(1000.0 * retry_interval));
                    boost::this_thread::sleep(boost::posix_time::milliseconds(lround(1000.0 * retry_interval)));
